...
const nav = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/admin/meetings", label: "Meeting Requests", icon: CalendarClock },
      { to: "/admin/messages", label: "Client Messages", icon: MessageSquare },
      { to: "/admin/support", label: "Support Requests", icon: LifeBuoy },
